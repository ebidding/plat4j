...
public class EbiddingV4GenerateCode extends AbstractGenerateCode {
	/**
	 * 获取action头部代码
	 * @return
	 */
	protected String getActionHeader(){
		...
		sb.append("@RequestMapping(\"{2}Action.do\")").append("\r\n");
		...
		sb.append("\tprivate static final String JSP_PREFIX = \"/{3}/{1}/\";").append("\r\n");
		sb.append("\r\n");
		sb.append("\tprivate String getJspPath(String method)'{'").append("\r\n");
		sb.append("\r\n");
		sb.append("\t\treturn JSP_PREFIX + method + JSP_SUFFIX;").append("\r\n");
		sb.append("\t'}'").append("\r\n");
	...
	protected String getActionMethod(String method){
		...
		sb.append("		return context.findBaseForward(getJspPath(\"{7}\"),spModel, srModel);").append("\r\n");
		sb.append("	'}'").append("\r\n");
