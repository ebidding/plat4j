/*
	...
	Author: WGY
	Version: 1.0
	Created Time: 2017年6月16日 下午4:07:05
	
	Revision History:
	Version          Date               Author			Comments
	1.0         	2017年6月16日下午4:07:05		WGY			Create file
=========================================================================
*/

package org.net.plat4j.core.mybatis;
...
public class SqlMapper {
     ...
     * @param factory
     */
    public SqlMapper(SqlSessionFactory factory) {
    	this.sqlSessionFactory = factory;
        this.sqlSession = factory.openSession();
        this.msUtils = new MSUtils(factory.getConfiguration());
    }
